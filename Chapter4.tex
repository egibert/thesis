...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.5\textwidth]{Results/Latency.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.5\textwidth]{Results/CDF_latency.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{Results/CDF_bandwidth.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{Results/LandB.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.5\textwidth]{Results/Cost_Microsoft.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=.5\textwidth]{Results/Cost_Amazon.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{Results/Scale.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{Results/Redeploy.pdf}
  \caption{Evaluation of the cost of redeploying a subset of operators over edge and cloud resources.}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{Results/Time.pdf}
