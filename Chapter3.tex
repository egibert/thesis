...
\subsubsection{Overhead Over Cloud Systems}
...
\subsubsection{Overhead Over Edge Systems}
...
\subsubsection{Performance Over Edge System}
...
\subsubsection{Information Propagating through the System}
...
\subsubsection{Performance of the Data Collection Layer Over Edge Systems}
...
\subsubsection{Scalability of Store/Query Operations Over Cloud Systems}
...
\subsubsection{Performance of the Query and Store Layer Over Edge Systems}
...
\subsubsection{Scalability and Overhead Over Edge and Cloud Systems}
...
\subsubsection{Performance Over Edge and Cloud Systems}
...
\subsubsection{Disaster Response Use Case}
...
\subsubsection{Smart City Use Case}
